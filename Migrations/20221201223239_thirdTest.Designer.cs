...
namespace HeroMed_API.Migrations
{
    ...
    [Migration("20221201223239_thirdTest")]
            ...
            modelBuilder.Entity("HeroMed_API.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Admin = true,
                            CreatedDate = new DateTimeOffset(new DateTime(2022, 12, 2, 0, 32, 38, 985, DateTimeKind.Unspecified).AddTicks(347), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            Admin = false,
                            CreatedDate = new DateTimeOffset(new DateTime(2022, 12, 2, 0, 32, 38, 985, DateTimeKind.Unspecified).AddTicks(363), new TimeSpan(0, 2, 0, 0, 0)),
                            EmployeeId = new Guid("0b273992-95bd-4baf-b298-92355f67b620"),
                            Password = "OParola",
                            Username = "UnUSername"
                        },
                        new
                        {
                            ...
                            Admin = false,
                            CreatedDate = new DateTimeOffset(new DateTime(2022, 12, 2, 0, 32, 38, 985, DateTimeKind.Unspecified).AddTicks(368), new TimeSpan(0, 2, 0, 0, 0)),
                            EmployeeId = new Guid("0b273992-95bd-4baf-b298-92355f67b621"),
                            Password = "AltaParola",
