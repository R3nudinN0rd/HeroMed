        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>().HasData(
                    new Employee()
                    {
                        ...
                        FirstName = "Mihai",
                        LastName = "Calugar",
                        Birthdate =new DateTime(day: 23, month: 3, year: 1978),
                        EmploymentDate = new DateTime(day: 20, month: 5, year: 2007),
                    ...
                    new Employee()
                    {
                        ...
                        FirstName = "George",
                        LastName = "Patrar",
                        Birthdate = new DateTime(day: 23, month: 3, year: 1968),
                        EmploymentDate = new DateTime(day: 20, month: 5, year: 2000),
                    ...
                    new Employee()
                    {
                        ...
                        FirstName = "admin",
                        LastName = "admin",
                        Birthdate = new DateTime(day: 1, month: 1, year:2000),
                        EmploymentDate = new DateTime(day: 1, month: 1, year: 2000),
                        PlaceOfBirth = " ",
                        Nationality = " ",
                        Address = " ",
